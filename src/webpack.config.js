...
const DEMO_BASE_DIR_ABSOLUTE_PATH = pathResolver.getAbsolutePath('/src');

const OUTPUT = {
  fsDirAbsolutePath: pathResolver.getAbsolutePath('/dist/assets'),
...
function demoJs() {
  return jsBundleFactory.createCustomJs({
    bundleName: 'demo-js',
    chunks: {
      'common': pathResolver.getAbsolutePath('./src/common.js'),
      //'theme/index': pathResolver.getAbsolutePath('./src/theme/index.js'),
    },
